...
** The OG LLM smarter-upper
   :PROPERTIES:
   :image:    img/step-by-step-etherial-ai-1.jpeg-crop-4-3.png|img/step-by-step-etherial-ai-2.jpeg-crop-4-3.png
   :END:
...
* Generate gptel directives
  ...
  + type: alist
    ...
    #+begin_src emacs-lisp :results none :tangle gptel-build-directives.el
