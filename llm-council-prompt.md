...
**USER CONTEXT**
- Primary editor: Emacs (org-mode preferred for outputs)
- Working on: A research package for syntopical reading
- Language capabilities: English, Spanish, German
- Project: Mesoamerican historiography (1400s-1600s, conquest period)
